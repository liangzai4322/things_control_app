...
ASSISTANT_GATEWAY_READ_TOKEN_CANONICAL_FILE="${ASSISTANT_GATEWAY_READ_TOKEN_CANONICAL_FILE:-/etc/taskbox-assistant-gateway-read-token}"
...
if [[ "$ASSISTANT_GATEWAY_READ_TOKEN_FILE" != "$ASSISTANT_GATEWAY_READ_TOKEN_CANONICAL_FILE" ]]; then
  install -m 0600 "$ASSISTANT_GATEWAY_READ_TOKEN_FILE" "$ASSISTANT_GATEWAY_READ_TOKEN_CANONICAL_FILE"
fi
