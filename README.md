...
- `docs/hq-primary-action-system-loop-v2.md`: 主动作席位、投产比候选、统一子系统接入、复盘校准与资源治理的唯一实施方案；P0–P4 已完成生产发布，P5–P6 已形成发布候选。
...
2026-08-23 P5–P6 发布候选：HQ 当前行动上方增加“本周唯一赌注”，只读取已批准月度押注；项目中心显示计划投入、实际投入、外部结果和资源判断；“系统白痴指数”读取周省六个可选治理指标，满 14 个观测日且五项指标齐全后才建议保留、简化或停止。缺失数据保持未知，草稿不进入正式赌注，治理建议不自动删功能或派任务。全量测试、周期桥接、Build ID`8956dbc8f134`及 1440px/390×844 无溢出、无控制台错误验收通过。
