...
export function renderExecutionPage(app) {
  ...
  app.innerHTML = `<main class="page execution-page safe-top safe-bottom">
    ...
    <section class="execution-outcomes execution-candidates"><header><div><span>V2 HISTORICAL BASELINE · NO CURRENT TASKS</span><h2>执行历史基线</h2></div><b>${candidateInbox.candidates.filter((item) => item.factStatus === 'historical_baseline').length} 历史记录 · 0 当前任务</b></header>
