...
- `docs/v3-five-system-gate-0-3.md` preserves the 2026-08-10 Session A Gate 0–3 baseline. `docs/v3-five-system-final-acceptance.md` is the current 2026-08-11 Session G handoff: B–F are locally integrated and jointly accepted at Build ID `eb3cac0b27a2`, but remain uncommitted, unpushed and undeployed. Mission/health/time/feedback use the unified HQ L1 read-only envelope; execution remains TaskBox L2 with only a local shadow proposal-draft outbox and no automatic consumer.
